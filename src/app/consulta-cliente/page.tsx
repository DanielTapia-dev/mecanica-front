...
export default function ConsultaClientePage() {
  return (
    <div className="flex min-h-screen flex-col items-center bg-gradient-to-b from-green-50 via-background to-background pb-12 sm:px-6 dark:from-green-950/20">
